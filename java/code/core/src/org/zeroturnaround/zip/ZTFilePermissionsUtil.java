...
/**
 * Utilities to manipulate {@link org.zeroturnaround.zip.ZTFilePermissions}.
 *
...
class ZTFilePermissionsUtil
   ...
   /**
    * Convert {@link org.zeroturnaround.zip.ZTFilePermissions} to POSIX file permission bit array.
    *
    *
   ...
   /**
    * Convert Posix mode to {@link org.zeroturnaround.zip.ZTFilePermissions}
    *
    * @param mode
    * @return
    */
