...
class Java7Nio2ApiPermissionsStrategy implements ZTFilePermissionsStrategy
   ...
   public Java7Nio2ApiPermissionsStrategy()
      ...
      posixFilePermissionClass = ZTZipReflectionUtil.getClassForName("java.nio.file.attribute.PosixFilePermission", Enum.class);
      ...
      linkOptionClass = ZTZipReflectionUtil.getClassForName("java.nio.file.LinkOption", Enum.class);
